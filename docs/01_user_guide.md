...
## 9. Special Workflow: Update Old Data

**File → Update Old Data...**

**Objective**
Re-process historical results—such as those generated by the legacy MATLAB tool (v3.3.0) or previous versions of MANIC—using the modern natural abundance correction and MRRF algorithms.
